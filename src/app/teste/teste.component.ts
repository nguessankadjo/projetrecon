...
export class TesteComponent implements OnInit {
  ...
  ListFacture:any = [];
  ListFactureEncours:any = [];
  ListFactureValider:any = [];
  ListFactureRejeter:any = [];
  ListFactureMaj:any = [];
  ...
  ngOnInit() {
    this.getAllRole();
    this.getAllUser();
    this.getAllFactureEncours();
    this.getAllFactureMAJ();
    this.getAllFactureRejetter();
    this.getAllFactureValider();

    // console.log('this.ListFactureEncours======++++', this.ListFactureEncours);


    // this.ListFactureEncours;
    // this.ListFactureMaj;
    // this.ListFactureRejeter;
...
if (this.userId) {
  ...
  getAllFactureEncours(){
    let endPoint = "facture"
    this.ServiceApiService.getOptionFind(endPoint, 1).subscribe(
      (response:any) => {
        this.ListFactureEncours = response;
        console.log('ListFacture EN', this.ListFactureEncours);
      },
      (error:any) => {
        console.log('error',error);
      }
  ...
  getAllFactureValider(){
    let endPoint = "facture"
    this.ServiceApiService.getOptionFind(endPoint, 3).subscribe(
      (response:any) => {
        this.ListFactureValider = response;
        console.log('ListFacture EN', this.ListFactureEncours);
      },
      (error:any) => {
        console.log('error',error);
  ...
  getAllFactureRejetter(){
    let endPoint = "facture"
    this.ServiceApiService.getOptionFind(endPoint, 2).subscribe(
      (response:any) => {
        this.ListFactureRejeter = response;
        console.log('ListFacture EN', this.ListFactureEncours);
      },
      (error:any) => {
        console.log('error',error);
  ...
  getAllFactureMAJ(){
    let endPoint = "facture"
    this.ServiceApiService.getOptionFind(endPoint, 4).subscribe(
      (response:any) => {
        this.ListFactureMaj = response;
        console.log('ListFacture EN', this.ListFactureEncours);
      },
      (error:any) => {
        console.log('error',error);
